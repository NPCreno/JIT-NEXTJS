        ...
        <main className="flex-grow w-auto top-16 flex-col pb-40 flex justify-start items-center gap-10 relative overflow-hidden">
          ...
          <div className="flex-col gap-9 w-full flex justify-between items-center sticky relative top-40">
            <div className="flex-col flex justify-between items-center">
              <div className="relative w-96 ring-2 ring-gray-200 shadow-lg rounded">
                <input className="w-full h-10 flex flex-row justify-between p-2 items-center  
                ring-gray-600 rounded focus:ring-2 
                focus:ring-violet-400 focus:outline-none cursor-pointer" 
              ...
              <div className="grid gap-8 grid-cols-1 ">
                {jobs.map((job) => (
                  <Link key={job.id} href={`/jobs/${job.id}`}>
                    ...
                    ring-2 ring-blue-500 flex items-center">
